...
{
    private $sdk, $maxFee, $network, $token_creation_fee, $xlm_funding_wallet, $xlm_funding_wallet_key;
    ...
    private function tokenCreationXLMFeeTransaction($distributor_wallet_key, $asset_code, $total_supply, $memo, $lock_status)
    {
        try {
