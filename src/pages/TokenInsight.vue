          ...
          <div class="stats">
            ...
            <div class="st flex flex-col justify-between">
              ...
              <div class="sub font-mono font-semibold"
                ...
                <template v-if="loading || liquidityLoading || historicalStatsLoading"><span
                    class="text-slate-500 text-[10px] font-normal animate-pulse">Loading...</span></template>
                <template v-else-if="historicalStats">
            ...
            <div class="card">
              <div class="card-hd">
                ...
                <div class="chart-tools select-none">
                  <div class="seg">
                    <span v-for="type in ['line', 'area']" :key="type"
          ...
          <aside class="rail" v-if="activeTab === 'about'">
            ...
            <div class="card" v-else>
              ...
              <div style="padding: 20px;" class="space-y-4">
                ...
                <div class="pt-2">
                  <button @click="verificationModal = true" class="btn cyan w-full py-2.5 font-bold select-none text-center block transition bg-cyan-500 hover:bg-cyan-400 text-slate-950 shadow-[0_0_20px_rgba(18,203,238,0.45)] hover:shadow-[0_0_25px_rgba(18,203,238,0.65)] hover:scale-[1.01] duration-300">
                    Claim Project
                  </button>
                </div>
              </div>
